     ...
     mainGui.innerHTML = `
            <div class="gui-header">
                ...
                <div class="header-buttons">
                   ...
                   <button id="btnMinimizeMain" style="bac<button id="btnMinimizeMain" style="background:transparent; border:none; color:#777;"><span class="btn-icon">✖</span></button>kground:transparent; border:none; color:#777;" onclick="window.toggleMainVisibility()"><span class="btn-icon">✖</span></button>
                </div>
            </div>
